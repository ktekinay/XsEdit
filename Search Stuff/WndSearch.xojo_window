...
Begin Window WndSearch
   ...
   Begin PlatformPushButton btnFindNext
      ...
      Width           =   125
   End
   Begin PlatformPushButton btnReplaceOne
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   125
   End
   Begin PlatformPushButton btnReplaceAll
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   125
   End
   Begin PlatformPushButton btnFindPrevious
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   125
   End
   Begin PlatformPushButton btnFindAll
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   125
   End
   Begin PlatformPushButton btnReplaceAndFind
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      Caption         =   "R&eplace && Find"
      Default         =   False
      Enabled         =   True
      Height          =   20
      HelpTag         =   ""
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		 Shared Function IsOpen() As Boolean
		  return mIsOpen
		End Function
	#tag EndMethod
...
#tag Events btnFindNext
	#tag Event
		Sub Action()
		  SearchReceiverBaseWindow.ActiveWindow.RaiseSearchEvent(SearchReceiverBaseWindow.FindTypes.FindNext, Options )
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btnReplaceOne
	#tag Event
		Sub Action()
		  SearchReceiverBaseWindow.ActiveWindow.RaiseSearchEvent(SearchReceiverBaseWindow.FindTypes.Replace, Options )
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btnReplaceAll
	#tag Event
		Sub Action()
		  SearchReceiverBaseWindow.ActiveWindow.RaiseSearchEvent(SearchReceiverBaseWindow.FindTypes.ReplaceAll, Options )
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btnFindPrevious
	#tag Event
		Sub Action()
		  SearchReceiverBaseWindow.ActiveWindow.RaiseSearchEvent(SearchReceiverBaseWindow.FindTypes.FindPrevious, Options )
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btnFindAll
	#tag Event
		Sub Action()
		  SearchReceiverBaseWindow.ActiveWindow.RaiseSearchEvent(SearchReceiverBaseWindow.FindTypes.FindAll, Options )
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events btnReplaceAndFind
	#tag Event
		Sub Action()
		  SearchReceiverBaseWindow.ActiveWindow.RaiseSearchEvent(SearchReceiverBaseWindow.FindTypes.ReplaceAndFind, Options )
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events fldFind
